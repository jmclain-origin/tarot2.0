...
const links: NavLink[] = [
  { title: "Home", path: "/", icon: "i-mdi:home" },
  { title: "About", path: "/about", icon: "i-mdi:information" },
];
const linkStyleTailwind = "text-2xl text-slate-900 hover:text-slate-700 hover:text-slate-600";
</script>
<template>
